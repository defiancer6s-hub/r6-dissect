...
func (i Operator) Role() TeamRole {
	...
	// New seasons ship operators before this table learns about them; an
	// unknown role must degrade the output, not abort the whole parse.
	log.Warn().Uint64("operatorID", uint64(i)).Msg("role unknown for operator ID")
	return ""
}
